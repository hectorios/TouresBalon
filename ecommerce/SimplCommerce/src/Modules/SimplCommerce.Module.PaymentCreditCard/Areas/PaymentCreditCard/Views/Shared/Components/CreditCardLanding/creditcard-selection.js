...
(function () {
    angular
        ...
        .directive('creditcardSelectionDirective', creditcardSelectionDirective);

    function productSelectionDirective() {
        var directive = {
            restrict: 'E',
            templateUrl: '_content/SimplCommerce.Module.PaymentCreditCard/Areas/PaymentCreditCard/Views/Shared/Components/CreditCardLanding/creditcard-selection.html',
            scope: {
